...
import { IContentSection, ICampaignGraphic, IPage, IPageFields } from '../@types/generated/contentful';
...
const convertToAllEntries = <T extends IPageFieldsItem | IContentSection | ICampaignGraphic>(block: T): T => {
